...
Original file is located at
    https://colab.research.google.com/drive/1qA-4hHuiotd3zfA0V13n2d7yeONZCv-o
...
df = pd.read_csv('/content/sample_data/SampleSuperstore.csv')  #loading dataset
...
df.groupby('Segment')[['Profit','Sales']].sum().plot.bar(color=['red','green'],figsize=(8,5))
...
*   Chairs have high sales but less 
profit compared to phones
